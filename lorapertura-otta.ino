...
const unsigned long airTimeMs = 10.7;  // Expresado en milisegundos
...
static const u1_t PROGMEM DEVEUI[8]={ 0xF1, 0xF1, 0xF1, 0xF1, 0xF1, 0xF1, 0xF1, 0xF1 };
void os_getDevEui (u1_t* buf) { memcpy_P(buf, DEVEUI, 8);}

// This key should be in big endian format (or, since it is not really a
// number but a block of memory, endianness does not really apply). In
// practice, a key taken from ttnctl can be copied as-is.
static const u1_t PROGMEM APPKEY[16] = { 0x09, 0xB7, 0x5C, 0x76, 0x86, 0x1C, 0x71, 0xCB, 0x23, 0x8B, 0xC0, 0x2E, 0x48, 0xD3, 0x75, 0x74 };
